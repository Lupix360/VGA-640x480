...
HD_PWD='/home/jlb/repo/vhdl/vga_initials/vga_initials.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_initials_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_initials_top.tcl -notrace
