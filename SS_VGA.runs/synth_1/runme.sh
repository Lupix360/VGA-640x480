...
HD_PWD='/home/jlb/repo/vhdl/vga_initials/vga_initials.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_initials_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_initials_top.tcl
